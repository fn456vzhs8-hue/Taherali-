...
- Live user-uploaded product images in the retail catalog.

## Current Catalog (mock.js)
- **Pickles ₹89 / 250g**: Mango, Vegetable, Lemon, Tomato — all now have real product images
- **Biscuits**: Fruit (400g/₹220 — image added), Cashew (400g/₹240), Osmania (400g/₹240), Pista (300g/₹270), Badam (300g/₹290)
- **Ghee**: Pure Ghee (250g/₹199)

## What's Been Implemented
### Feb 2026 — Live Product Images
- Mapped 5 uploaded images to retail products in `/app/frontend/src/mock.js` (Mango, Vegetable, Lemon, Tomato pickles + Fruit Biscuit).
...
- Verified via screenshot: Retail Catalog + Product Detail render photos correctly.
...
## Backlog / Roadmap
### P1
- Upload remaining product images (Cashew Biscuit, Osmania Biscuit, Pista Biscuit, Badam Biscuit, Pure Ghee) and map them into mock.js the same way.
...
- Feb 2026 image mapping: verified via screenshot (Retail Catalog + Mango Achar detail render real photos).
- No backend yet.
